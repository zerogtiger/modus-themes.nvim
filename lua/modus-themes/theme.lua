...
function M.setup()
    ...
    CursorColumn = { fg = c.none, bg = c.bg_hl_line }, -- Screen-column at the cursor, when `cursorcolumn` is set.
		...
		PmenuSel = { fg = c.fg_main, bg = c.bg_magenta_intense }, -- Popup menu: selected item.
		...
		NvimTreeRootFolder = { fg = c.cyan_cooler, bold = true },
		...
		IndentBlanklineContextChar = { fg = c.magenta_faint, nocombine = true },
		IblIndent = { fg = c.border, nocombine = true },
		IblScope = { fg = c.magenta_faint, nocombine = true },
